      ...
      <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          <div class="flex items-center space-x-6">
            <div class="relative">
              <img :src="userProfile.avatar" alt="Profile" class="w-24 h-24 rounded-full object-cover border-4 border-white shadow-lg" />
              <button class="absolute bottom-0 right-0 bg-blue-600 text-white p-2 rounded-full shadow-lg hover:bg-blue-700">
            ...
            <div class="flex-1">
              ...
              <div class="mt-4 flex space-x-4">
                ...
                <div class="text-center">
                  <p class="text-2xl font-bold text-gray-800">{{ userProfile.certificatesEarned }}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="md:col-span-2">
              ...
              <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" v-model="userProfile.name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
                    <input type="text" v-model="userProfile.username" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                  </div>
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                  <input type="email" v-model="userProfile.email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Bio</label>
                  <textarea v-model="userProfile.bio" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div class="space-y-4">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Preferred Learning Time</label>
                  <div class="flex space-x-4">
                    <label v-for="time in learningTimes" :key="time" class="flex items-center">
                      <input type="radio" :value="time" v-model="userProfile.preferredTime" class="mr-2" />
                      <span>{{ time }}</span>
                    </label>
                  </div>
                </div>
                <div>
                  ...
                  <div class="flex flex-wrap gap-2">
                    <button v-for="goal in learningGoals" :key="goal"
          ...
          <div class="md:col-span-1">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div class="space-y-4">
                <div v-for="badge in userProfile.badges" :key="badge.id" 
