          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Student</th>
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Progress</th>
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Assignments</th>
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Last Active</th>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="student in filteredStudents" :key="student.id">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span class="text-sm text-gray-900">{{ student.completedAssignments }}/{{ student.totalAssignments }}</span>
                  </td>
          ...
          <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
            <div class="flex justify-between items-center">
              <div class="text-sm text-gray-900">
                Showing {{ paginationStart }} to {{ paginationEnd }} of {{ totalStudents }} results
              </div>
    ...
    const exportData = () => {
      ...
      const csvContent = 'data:text/csv;charset=utf-8,' + 
        ...
        filteredStudents.value.map(student => 
          student.name + ',' + student.email + ',' + student.progress + '%,' + 
